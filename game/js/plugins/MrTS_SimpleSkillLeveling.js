...
(function() {
	...
	//adjust use time for mobile deployment
	uses = Math.floor(uses*0.6);

		this._leveledSkills[skill.id]++;
//doranikofu edit, special state doubles use time
		if (this.isStateAffected(133))
		{
			this._leveledSkills[skill.id]++;
		}
