...
(function() {
    ...
    PHQuestBook.prototype.clearQuests = function() {
        for (var i = 0; i < PHPlugins.PHQuests.quests.length; i++) {
			//doranikofu edit, only clear primary quests
			if (PHPlugins.PHQuests.quests[i].type == 'primary')
			{
...
Window_QuestBookDetails.prototype.initialize = function() {
    ...
    } else if (PHPlugins.Params.PHQuestDisplayType == 2) //doranikofu custom
    {
        Window_Selectable.prototype.initialize.call(this, 450, 200, 520, 440);
    }
...
Window_QuestBookList.prototype.initialize = function() {
    ...
    if (PHPlugins.Params.PHQuestDisplayType == 0) {
		...
		Window_Selectable.prototype.initialize.call(this, 0, 150, 400, 620);
    }
...
//doranikofu edit location        this._backgroundSprite.bitmap = ImageManager.loadPicture(PHPlugins.Params.PHQuestBackgroundImage);
		this._backgroundSprite.bitmap = ImageManager.loadSystem(PHPlugins.Params.PHQuestBackgroundImage);
...
Scene_QuestBook.prototype.createWindowCategory = function() {
	...
	this._categoryWindow.x = 30;
	this._categoryWindow.y = 20;
	this._categoryWindow.width = 964;
};
