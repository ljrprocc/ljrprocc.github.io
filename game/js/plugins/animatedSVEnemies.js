...
Sprite_Enemy.prototype.updateBitmap = function() {
 ...
 Rexal.ASVE.Sprite_Enemy_updateBitmap.call(this);
	...
	if(!this._enemy._breathless && Rexal.ASVE.Breathe && this._enemy.canMove()){
		var a = 1;
...
//doranikofu edit
	//var ss = Graphics.boxHeight/490+.3;
	//if(Rexal.ASVE.ScaleStatics)var s = ss*(this._homeY/Graphics.boxHeight)*this._enemy._scale;
	if(Rexal.ASVE.ScaleStatics)var s = (0.78+0.3*this.y/Graphics.boxHeight)*this._enemy._scale;
