//=============================================================================
// doranikofu's edit to other plugins for option menu, editted from YEP_CreditsPage.js
//=============================================================================

var Imported = Imported || {};
Imported.window_option = true;
 ...
 * @author Yanfly Engine Plugins edited by doranikofu
 *
 * @param ---General---
 * @default
 *
...
Yanfly.Parameters = PluginManager.parameters('window_option');
...
Window_Options.prototype.makeCommandList = function() {
	...
	this.addCommand(text, 'credits', true);
};
...
Window_Options.prototype.drawItem = function(index) {
	...
	if (this.commandSymbol(index) != 'credits'){
...
Yanfly.Credits.Scene_Options_createOptionsWindow =
    Scene_Options.prototype.createOptionsWindow;
Scene_Options.prototype.createOptionsWindow = function() {
    Yanfly.Credits.Scene_Options_createOptionsWindow.call(this);
    this._optionsWindow.setHandler('credits',  this.CreditsWindow.bind(this));
};

Scene_Options.prototype.CreditsWindow = function() {
...
AudioManager.updateBgsParameters = function(bgs) {
    this.updateBufferParameters(this._bgsBuffer, this._seVolume, bgs);
};

AudioManager.updateMeParameters = function(me) {
    this.updateBufferParameters(this._meBuffer, this._bgmVolume, me);
};
