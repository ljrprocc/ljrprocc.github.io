...
Window_ManualEntryList.prototype.initialize = function() {
    ...
    if(showNavigationWindow && navigationWindowPos === 'top'){
    	y = 72;//this.fittingHeight(1);//edit for mobile 
	}
...
Window_ManualEntryList.prototype.windowHeight = function() {
	if (showNavigationWindow) {
    	return Graphics.boxHeight -72;// this.fittingHeight(1);//edit for mobile 
	}
	return Graphics.boxHeight;
};
//edit for mobile 
Window_ManualEntryList.prototype.lineHeight = function() {
    return 64;
};
