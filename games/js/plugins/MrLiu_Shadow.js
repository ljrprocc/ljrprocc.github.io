...
Sprite_Character.prototype.createShadowSet = function() {
    ...
    this._shadowSprite.y = this.y -5;	//custom offset
...
Sprite_Character.prototype.update_character_shadow = function() {
	//custom percetage default 100
	this._shadowSprite.scale.x = ((this.patternWidth() * 50) / 48) / 90.0;
